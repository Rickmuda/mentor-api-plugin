...
/* Sterren-SVG's worden door wp_kses_post gestript -> lege rij; verbergen zodat er geen
   dode ruimte boven de titel overblijft. De titel staat zo op de regel van de quote. */
#<?php echo esc_attr($instance_id); ?> .lc-card-stars { display: none; }
#<?php echo esc_attr($instance_id); ?> .lc-card-title {
    ...
    color: var(--lc-ink);
    margin: 0 0 12px 0;
    padding-right: 44px; /* ruimte voor de quote rechtsboven */
}
