...
#<?php echo esc_attr($instance_id); ?> .lc-grid {
    ...
    gap: 22px;
    margin-bottom: 36px;
    align-items: start; /* kaarten houden eigen hoogte; uitklappen rekt buurkaart niet mee */
}
...
@media (hover: hover) and (pointer: fine) {
    #<?php echo esc_attr($instance_id); ?> .lc-acc-btn:hover { background: #FDE68A; }
}
...
<div id="<?php echo esc_attr($instance_id); ?>">
    <div class="lc-wrap">
        ...
        <p class="lc-empty" id="<?php echo esc_attr($instance_id); ?>-empty" style="display:none;text-align:center;color:#586575;margin:8px 0 0;">Geen beschikbare startdata op dit moment - zet de filter uit om alle datums te zien.</p>
